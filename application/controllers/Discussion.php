...
class Discussion extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['title'] = translate('discussion');
        $this->data['sub_page'] = 'discussion/index';
        $this->data['main_menu'] = 'discussion';
    ...
    public function types()
    {
        ...
        $this->data['sub_page'] = 'discussion/types';
        $this->data['main_menu'] = 'discussion';
        $this->data['title'] = translate('discussion_type');
        $this->load->view('layout/index', $this->data);
    }
