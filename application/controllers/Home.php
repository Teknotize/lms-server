    ...
    public function admission()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                /* $brnch = $this->db->get('branch')->row();

                echo "<pre>".print_r($brnch)."</pre>";

                echo "URL:". base_url(uri_string());
                echo "<br>";
                echo "here and success";
                exit; */
                $url = base_url(uri_string());
                $this->session->set_flashdata('success_message', 'You form has been submitted successfully.');
