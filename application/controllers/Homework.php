...
class Homework extends Admin_Controller
{
    ...
    protected function homework_validation()
    {
        ...
        $this->form_validation->set_rules('date_of_homework', translate('date_of_assignment'), 'trim|required');
        ...
        $this->form_validation->set_rules('homework', translate('assignment'), 'trim|required');
