...
class Hostels extends Admin_Controller
{
    ...
    protected function hostel_validation()
    {
        ...
        $this->form_validation->set_rules('category_id', translate('group'), 'required');
    ...
    protected function category_validation()
    {
        ...
        $this->form_validation->set_rules('category_name', translate('group'), 'trim|required|callback_unique_category');
    ...
    public function category()
    {
        ...
        $this->data['title'] = translate('group');
    ...
    protected function room_validation()
    {
        ...
        $this->form_validation->set_rules('category_id', translate('group'), 'trim|required');
