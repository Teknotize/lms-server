                        ...
                        <div class="sign-area">
                            ...
                            <?php echo form_open($this->uri->uri_string()); ?>
                                ...
                                <div class="sign-footer">
                                    <p style="color:#fff;"><?php echo $global_config['footer_text'];?></p>
                                    <!-- <P style="font-size: 13px;" class="text-center">Content Provided By 
                                        <strong><a target="_blank" href="https://east.education/">East Education</a></strong> 
                                        B-29, Block 3, Gulshan e Iqbal, Karachi, Pakistan
                                    </P> -->
                                </div>
                            <?php echo form_close();?>
                        </div>
