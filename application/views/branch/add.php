	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?= (empty($validation_error) ? 'active' : '') ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?= translate('institution_list') ?></a>
			</li>
			<li class="<?= (!empty($validation_error) ? 'active' : '') ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?= translate('create_institution') ?></a>
			</li>
		</ul>
		<div class="tab-content">
					...
					<table class="table table-bordered table-hover table-condensed mb-none table-export">
						<thead>
							<tr>
								...
								<th><?= translate('institution_name') ?></th>
			...
			<div class="tab-pane <?= (!empty($validation_error) ? 'active' : '') ?>" id="create">
				...
				<div class="form-group mt-md">
					<label class="col-md-3 control-label"><?= translate('institution_name') ?> <span class="required">*</span></label>
					<div class="col-md-6">
