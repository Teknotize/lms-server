...
<div class="alert alert-danger">
    <i class="fas fa-exclamation-triangle"></i> This School management system may not work properly because
    "ONLY_FULL_GROUP_BY" is enabled, <strong>Strongly recommended</strong> - consult with your hosting provider to
    disable "ONLY_FULL_GROUP_BY" in sql_mode configuration.
</div>
<?php } ?>
...
<div class="dashboard-page">
    <div class="row">
        ...
        <div
            class="<?php echo get_permission('annual_student_fees_summary_chart', 'is_view') ? 'col-md-12 col-lg-4 col-xl-3' : 'col-md-12'; ?>">
            <section class="panel pg-fw">
                <div class="panel-body">
                    <h4 class="chart-title mb-xs">
                        <?=translate('income_vs_expense_of') . " " . translate(strtolower(date('F')))?></h4>
                    <div id="cash_book_transaction"></div>
                    <div class="round-overlap"><i class="fab fa-sellcast"></i></div>
                    <div class="text-center">
                        <ul class="list-inline">
                            <li>
                                <h6 class="text-muted"><i class="fa fa-circle text-blue"></i> <?=translate('income')?>
                                </h6>
                            </li>
                            <li>
                                <h6 class="text-muted"><i class="fa fa-circle text-danger"></i>
                                    <?=translate('expense')?></h6>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div
            class="<?php echo get_permission('monthly_income_vs_expense_chart', 'is_view') ? 'col-md-12 col-lg-8 col-xl-9' : 'col-md-12'; ?>">
            <section class="panel">
                <div class="panel-body">
                            ...
                            <div class="widget-col-in row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="box-top-line line-color-primary">
                                        <span
                                            class="text-muted text-uppercase"><?php echo translate('total_strength'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            style="width: <?php echo $presentPercentage; ?>%;">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            style="width: <?php echo $absentPercentage; ?>%;">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-warning" role="progressbar"
                                            style="width: <?php echo $latePercentage; ?>%;">
                        ...
                        <div class="panel-body">
							...
							?>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            style="width: <?php echo $attendanceData['present_percentage']; ?>%;">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            style="width: <?php echo $attendanceData['absent_percentage']; ?>%;">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-warning" role="progressbar"
                                            style="width: <?php echo $attendanceData['late_percentage']; ?>%;">
                    ...
                    <div class="col-lg-3 col-sm-6 ">
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <i class="fas fa-users"></i>
                                    <h5 class="text-muted"><?php echo translate('Full Time'); ?></h5>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right mt-md text-primary"><?php
									$jobPostingData = $this->dashboard_model->getJobPosting('full_time', $school_id);
									echo $jobPostingData['snumber'];
								?></h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="box-top-line line-color-primary">
                                        <span class="text-muted text-uppercase"><?php echo translate('total'); ?></span>
                                    </div>
                                </div> 
                                <!-- no_of_posts -->
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    <span class="text-muted"><?php echo translate('no_of_empty_posts'); ?> </span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            style="width: <?php echo $jobPostingData['no_of_empty_posts']; ?>%;">
                                            <?php echo round($jobPostingData['no_of_empty_posts'], 2); ?>%
                                        </div>
                                    </div>
                                </div>
                                <!-- no_of_filled_posts -->
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    <span class="text-muted"><?php echo translate('no_of_filled_posts'); ?></span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            style="width: <?php echo $jobPostingData['no_of_filled_posts']; ?>%;">
                                            <?php echo round($jobPostingData['no_of_filled_posts'], 2); ?>%
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 ">
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <i class="fas fa-users"></i>
                                    <h5 class="text-muted"><?php echo translate('Part Time'); ?></h5>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right mt-md text-primary"><?php
									$jobPostingData = $this->dashboard_model->getJobPosting('part_time', $school_id);
									echo $jobPostingData['snumber'];
								?></h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-3 col-sm-6 ">
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <i class="fas fa-users"></i>
                                    <h5 class="text-muted"><?php echo translate('contract'); ?></h5>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right mt-md text-primary"><?php
									$jobPostingData = $this->dashboard_model->getJobPosting('contract', $school_id);
									echo $jobPostingData['snumber'];
								?></h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-3 col-sm-6 ">
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <i class="fas fa-users"></i>
                                    <h5 class="text-muted"><?php echo translate('Ticket Status'); ?></h5>
                                </div>
                                <?php
									$ticket_status = $this->dashboard_model->get_ticket_status($school_id); 
							 	?>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right mt-md text-primary">
                                        <?php echo $ticket_status['total_tickets']; ?>
                                </h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="box-top-line line-color-primary">
                                ...
                                <!-- open -->
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    <span class="text-muted"><?php echo translate('open'); ?> </span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            style="width: <?php echo ($ticket_status['open'] / $ticket_status['total_tickets']) * 100;?>%;">
                                            <?php echo round(($ticket_status['open'] / $ticket_status['total_tickets']) * 100, 2); ?>%
                                        </div>
                                    </div>
                                </div>
                                <!-- closed -->
                                <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
                                    <span class="text-muted"><?php echo translate('closed'); ?></span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            style="width: <?php echo ($ticket_status['closed'] / $ticket_status['total_tickets']) * 100; ?>%;">
                                            <?php echo round(($ticket_status['closed'] / $ticket_status['total_tickets']) * 100, 2); ?>%
                                        </div>
                                    </div>
                                </div>  
    ...
    <div class="row">
        ...
        <div
            class="<?php echo get_permission('weekend_attendance_inspection_chart', 'is_view') ? 'col-md-12 col-lg-4 col-xl-3' : 'col-md-12'; ?>">
            <section class="panel pg-fw">
                <div class="panel-body">
        ...
        <div
            class="<?php echo get_permission('student_quantity_pie_chart', 'is_view') ? 'col-md-12 col-lg-8 col-xl-9' : 'col-md-12'; ?>">
            <section class="panel">
                <div class="panel-body">
                        ...
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="box-top-line line-color-primary">
                                        <span
                                            class="text-muted text-uppercase"><?php echo translate('interval_month'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="box-top-line line-color-primary">
                                        <span
                                            class="text-muted text-uppercase"><?php echo translate('total_number'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="box-top-line line-color-primary">
                                        <span
                                            class="text-muted text-uppercase"><?php echo translate('total_route'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row widget-row-in">
                        ...
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <a
                                        href="<?php echo base_url('birthday/student') ?>" data-toggle="tooltip"
                                        data-original-title="<?=translate('view') . " " . translate('list')?>"><i
                    ...
                    <div class="col-xs-12">
                        <div class="panel-body">
                            <div class="widget-col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <a
                                        href="<?php echo base_url('birthday/staff') ?>" data-toggle="tooltip"
                                        data-original-title="<?=translate('view') . " " . translate('list')?>"><i
                                            class="fas fa-birthday-cake"></i></a>
...
<div class="zoom-anim-dialog modal-block modal-block-primary mfp-hide" id="modal">
    <section class="panel">
        <header class="panel-heading">
            <div class="panel-btn">
                <button onclick="fn_printElem('printResult')" class="btn btn-default btn-circle icon"><i
...
(function($) {
    ...
    var color = ['#546570', '#c4ccd3', '#c23531', '#2f4554', '#61a0a8', '#d48265', '#91c7ae', '#749f83', '#ca8622',
        '#bda29a', '#6e7074'
    ];
