...
<section class="panel">
	<ol class="breadcrumb">
		...
		<?php $grd = $this->db->where('id', $this->data['grade_id'])->get('class')->row(); ?>
	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?= (empty($validation_error) ? 'active' : '') ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?= translate('subjects') ?></a>
			</li>
		</ul>
				...
				<div class="mb-md">
					...
					?>
							...
							<div style="border: 1px solid <?php echo $selected_color; ?>;" class="subject_object">
								<a href="<?=base_url('digital_library/subject/'. $row->branch_id.'/'. $row->class_id.'/'.$row->subject_id)?>" style="text-decoration: none; color: inherit;">
									<div class="media">
