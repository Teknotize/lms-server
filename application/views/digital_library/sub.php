...
<section class="panel">
	...
	<div class="container-fluid">
		<h4 class="text-center"><?= translate('Weeks') ?></h4>
			...
			<ul style="margin:0px;" class="pagination">
				<?php foreach ($pagination_links as $arr) : ?>
					<li class="<?php echo ($current_page == $arr['page']) ? 'active' : ''; ?>">
						<a style="padding-left: 5px; padding-right: 5px;border-radius: 0px;" href="<?php echo $arr['link']; ?>"><?php echo $arr['page']; ?></a>
					</li>
				<?php endforeach; ?>
			</ul>
		</div>
		...
		<div class="tab-content">
			...
			<div class="container-fluid">
				...
				?>
					<div class="">
						<div class="col-lg-3">
							<div style="" class="scroller-video">
								<!-- Left side tabs -->
														...
														<div class="tab-pane <?php echo $j == 1 ? 'active' : ''; ?>" id="tab_<?php echo $resource->id; ?>">
															...
															<?php else : ?>
																<div id="pdf-container_<?php echo $resource->id; ?>">
																	<object data="<?php echo base_url('uploads/attachments/' . $resource->enc_name); ?>" type="application/pdf" width="100%" height="100%">
