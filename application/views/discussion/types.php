	...
	<div class="col-md-5">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><?=translate('add') . " " . translate('discussion_type')?></h4>
			</header>
...
<?php if (get_permission('event_type', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('event_type', 'is_add')){ echo "7"; }else{ echo "12"; } ?>">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="fas fa-list-ul"></i> <?=translate('discussion_type') . " " . translate('list')?></h4>
			</header>
			<div class="panel-body">
						...
						<tbody>
							...
							<tr>
								...
								<?php endif; if (get_permission('event_type', 'is_delete')): ?>
									<!-- delete link -->
									<?php echo btn_delete('discussion/type_delete/' . $row['id']);?>
								<?php endif; ?>
								</td>
							</tr>
							<?php
...
<div class="zoom-anim-dialog modal-block modal-block-primary mfp-hide" id="modal">
	<section class="panel">
		<?php echo form_open('event/types_edit', array('class' => 'frm-submit')); ?>
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-edit"></i> <?=translate('edit') . " " . translate('discussion_type')?></h4>
			</header>
			<div class="panel-body">
