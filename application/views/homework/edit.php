	...
	<div class="col-md-12">
		<section class="panel">
			...
			<header class="panel-heading">
				<h4 class="panel-title"><i class="fas fa-plus-circle"></i> <?=translate('edit') . " " . translate('assignment')?></h4>
			</header>
			<div class="panel-body mb-md">
				...
				<div class="form-group">
					<label class="col-md-3 control-label"><?=translate('date_of_assignment')?> <span class="required">*</span></label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-3 control-label"><?=translate('assignment')?> <span class="required">*</span></label>
					<div class="col-md-6">
