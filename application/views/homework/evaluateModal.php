...
<div class="row">
	<div class="col-md-8">
		<label><span class="text-weight-semibold"><?=translate('assignment')?> :</span></label>
		<div class="alert alert-subl text-dark"><?=$row['description']?></div>
	</div>
	<div class="col-md-4">
		<label><span class="text-weight-semibold"><?=translate('date_of_assignment')?></span> : <?=_d($row['date_of_homework'])?></label><br>
