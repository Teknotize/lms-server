...
<div class="row">
	<div class="col-md-12">
			...
			<?php if (get_permission('homework', 'is_add')): ?>
				<div class="panel-btn">
					<a href="<?=base_url('homework/add')?>" id="addLeave" class="btn btn-default btn-circle" >
						<i class="fas fa-plus-circle"></i> <?=translate('add') . " " . translate('assignment')?>
					</a>
				</div>
			<?php endif; ?>
			</header>
		...
		<section class="panel appear-animation" data-appear-animation="<?php echo $global_config['animations'];?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="fas fa-list"></i> <?=translate('assignment')?></h4>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-export">
					<thead>
						<tr>
							...
							<th><?=translate('date_of_assignment')?></th>
