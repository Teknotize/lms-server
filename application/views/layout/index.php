		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<p style="color:green; text-align:center; margin-bottom:0px;"><a style="color:inherit;" target="_blank" href="">Provided By SCO to Education Department ©</a></p>
					<P style="font-size: 13px;" class="text-center">SNC Approved Content By
						<strong><a target="_blank" href="https://mofept.gov.pk/">Federal Ministry of Education</a></strong>
						Islamabad, Pakistan
					</P>
				</section>
			</div>
