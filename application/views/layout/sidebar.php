        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <!-------------------------------LMS Library----------------------------------------->
                    <?php if (is_superadmin_loggedin()) { ?>
                        <li class="nav-parent <?php if ($main_menu == 'digital_library') echo 'nav-expanded nav-active'; ?>">
                            <a>
                                <i class="icons icon-earphones-alt"></i><span><?= translate('lms_library') ?></span>
                            </a>
                            <ul class="nav nav-children">
                                <?php
                                ...
                                $branches = $this->db->get('branch')->result();
                                //$grades = $this->db->get('class')->result();
                                ?>
                                <?php foreach ($branches as $branch) { ?>
                                    <li class="nav-parent <?php if ($branch_id == $branch->id) echo 'nav-expanded nav-active'; ?>">
                                        <a>
                                            <i class="fas fa-store-alt"></i><span><?= translate('' . $branch->name . '') ?></span>
                                        </a>
                                        <ul class="nav nav-children">
                                            <?php $grades = $this->db->where('branch_id', $branch->id)->get('class')->result(); ?>
                                            <?php foreach ($grades as $grade) { ?>
                                                <li class="<?php if ($grade_id == $grade->id) echo 'nav-active'; ?>">
                                                    <a href="<?= base_url('digital_library/grade/' . $branch->id . '/' . $grade->id) ?>">
                                                        <span>
                                                            <i class="fas fa-caret-right" aria-hidden="true"></i>
                                                            <?= translate('' . $grade->name . '') ?>
                                                        </span>
                                                    </a>
                                                </li>
                                            <?php } ?>
                    ...
                    <?php } else { ?>
                        <li class="nav-parent <?php if ($main_menu == 'digital_library') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                $staff = $this->db->where('id', $user_id)->get('staff')->row();
                                ?>

                                <?php $grades = $this->db->where('branch_id', $staff->branch_id)->get('class')->result(); ?>
                                <?php foreach ($grades as $grade) { ?>
                                    <li class="<?php if ($grade_id == $grade->id) echo 'nav-active'; ?>">
                                        <a href="<?= base_url('digital_library/grade/' . $staff->branch_id . '/' . $grade->id) ?>">
                                            <span>
                                                <i class="fas fa-caret-right" aria-hidden="true"></i>
                                                <?= translate('' . $grade->name . '') ?>
                                            </span>
                    ...
                    <?php if (is_superadmin_loggedin()) { ?>
                        <!-- <li class="nav-parent <?php if ($main_menu == 'lms_grades') echo 'nav-active nav-expanded'; ?>">
                        <a>
                            <i class="fas fa-area-chart"></i><span><?= translate('LMS Grades') ?></span>
                        </a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($main_menu == 'lms_grades' && empty($school_id)) echo 'nav-active'; ?>">
                                <a href="<?= base_url('lms_grades/index') ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?= translate('LMS Grades') ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-parent <?php if ($main_menu == 'lms_subjects') echo 'nav-active nav-expanded'; ?>">
                        <a>
                            <i class="fas fa-book"></i><span><?= translate('LMS Subjects') ?></span>
                        </a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($main_menu == 'lms_subjects' && empty($school_id)) echo 'nav-active'; ?>">
                                <a href="<?= base_url('lms_subjects/index') ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?= translate('LMS Subjects') ?></span>
                                </a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <?php if (0) { ?>
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'inventory' || $main_menu == 'inventory_report') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php }
                                if (get_permission('product_category', 'is_view')) { ?>
                                ...
                                <?php }
                                if (get_permission('product_unit', 'is_view')) {  ?>
                                ...
                                <?php }
                                if (get_permission('product_sale', 'is_view')) { ?>
                    ...
                    if (is_superadmin_loggedin()) : ?>
                        ...
                        <li class="<?php if ($main_menu == 'branch') echo 'nav-active'; ?>">
                            <a href="<?= base_url('branch') ?>">
                                <i class="icons icon-directions"></i><span><?= translate('institutions') ?></span>
                            </a>
                        </li>
                    <?php endif;
                                ...
                                if (get_permission('student_category', 'is_view')) { ?>
                                    <li class="<?php if ($sub_page == 'student/category') echo 'nav-active'; ?>">
                                        <a href="<?= base_url('student/category') ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?= translate('group') ?></span>
                                        </a>
                                    </li>
                                <?php } ?>
                            </ul>
                    ...
                    ?>
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'student') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php }
                                if (get_permission('disable_reason', 'is_view')) { ?>
                    ...
                    if (moduleIsEnabled('human_resource')) {
                        if (
                            ...
                            get_permission('performance', 'is_view') ||
                            get_permission('promotions', 'is_view') ||
                            get_permission('job_posting', 'is_view')
                        ) {
                    ?>
                            <!-- human resource -->
                            <li class="nav-parent <?php if ($main_menu == 'payroll' || $main_menu == 'advance_salary' || $main_menu == 'leave' || $main_menu == 'award' || $main_menu == 'promotions' || $main_menu == 'performance' || $main_menu == 'transfer_posting' || $main_menu == 'job_posting') echo 'nav-expanded nav-active'; ?>">
                                <a>
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <?php } ?>
                                    <?php if (get_permission('job_posting', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'job_posting/index' || $sub_page == 'job_posting/add' || $sub_page == 'job_posting/edit' || $sub_page == 'job_posting/vacant_filled') echo 'nav-active'; ?>">
                                            <a href="<?= base_url('job_posting/index') ?>">
                                                <i class="fas fa-crown"></i>
                                                <span><?= translate('job_postings') ?></span>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if (get_permission('performance', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'performance/index' || $sub_page == 'job_posting/add' || $sub_page == 'job_posting/edit' || $sub_page == 'job_posting/vacant_filled') echo 'nav-active'; ?>">
                                            <a href="<?= base_url('performance/index') ?>">
                                                <i class="fas fa-crown"></i>
                    ...
                    ?>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'attachments') echo 'nav-expanded nav-active'; ?>">
                                <a>
                                    <i class="icons icon-cloud-upload"></i><span><?= translate('content_management') ?></span>
                                </a>
                                <ul class="nav nav-children">
                    ...
                    ?>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'homework') echo 'nav-expanded nav-active'; ?>">
                                <a>
                                    <i class="icons icon-note"></i><span><?= translate('assignment') ?></span>
                                </a>
                                <ul class="nav nav-children">
                                    <?php if (get_permission('homework', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'homework/index' || $sub_page == 'homework/add' || $sub_page == 'homework/evaluate_list' || $sub_page == 'homework/edit') echo 'nav-active'; ?>">
                                            <a href="<?= base_url('homework') ?>">
                                                <span><i class="fas fa-caret-right" aria-hidden="true"></i><?= translate('assignment') ?></span>
                                            </a>
                                        </li>
                                    <?php }
                    ...
                    ?>
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'mark' || $main_menu == 'exam_timetable') echo 'nav-expanded nav-active'; ?>">
                            <a>
                                <i class="icons icon-book-open" aria-hidden="true"></i><span><?= translate('examination') ?></span>
                            </a>
                            <ul class="nav nav-children">
                                <?php
                                if (
                    ...
                    <?php if ($this->app_lib->isExistingAddon('qrcode') && moduleIsEnabled('qr_code_attendance')) {
                        if (
                            get_permission('qr_code_student_attendance', 'is_add') ||
                    ...
                    ?>
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'settings' || $main_menu == 'school_m') echo 'nav-expanded nav-active'; ?>">
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php }
                                if (get_permission('add_modules', 'is_add')) { ?>
                                    <li class="<?php if ($sub_page == 'modules_and_permissions/modules') echo 'nav-active'; ?>">
                                        <a href="<?= base_url('modules_and_permissions/modules') ?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?= translate('add_module') ?></span>
                                        </a>
                                    </li>
                                <?php }
