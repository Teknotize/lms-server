					...
					<tbody>
						...
						<?php } } ?>
							...
							<?php if ($row['status']  != 2 && get_permission('online_admission', 'is_add')) { ?>
								...
								<a download="true" href="<?php echo base_url('uploads/images/student/' . $row['student_photo']);?>" class="btn btn-default btn-circle icon" data-toggle="tooltip"
								data-original-title="<?=translate('download_Photo')?>">
