                    ...
                    <li class="nav-parent <?php if ($main_menu == 'digital_library') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            <?php
                                ...
                                $grades = $this->db->get('lms_grades')->result();
                                foreach($grades as $grade) {
                            ?>
                                    <li class="<?php if ($grade_id == $grade->id) echo 'nav-active'; ?>">
                                        <a href="<?=base_url('digital_library/grade/'. $grade->id)?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i> <?=translate(''. $grade->grade_name .'')?></span>
                                        </a>
                                    </li>
                            <?php } ?>
                        </ul>
